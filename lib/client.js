...
var MarketplaceSettingsSection_default = { "heading": "y9bfmW_heading", "sourceLabel": "y9bfmW_sourceLabel", "description": "y9bfmW_description", "headingRow": "y9bfmW_headingRow", "list": "y9bfmW_list", "failure": "y9bfmW_failure", "empty": "y9bfmW_empty", "intro": "y9bfmW_intro", "sources": "y9bfmW_sources", "tabs": "y9bfmW_tabs", "search": "y9bfmW_search", "cardTop": "y9bfmW_cardTop", "cardTitle": "y9bfmW_cardTitle", "visuallyHidden": "y9bfmW_visuallyHidden", "restart": "y9bfmW_restart", "marketRow": "y9bfmW_marketRow", "panel": "y9bfmW_panel", "status": "y9bfmW_status", "hint": "y9bfmW_hint", "source": "y9bfmW_source", "card": "y9bfmW_card", "tag": "y9bfmW_tag", "field": "y9bfmW_field", "section": "y9bfmW_section", "button": "y9bfmW_button", "actions": "y9bfmW_actions", "tab": "y9bfmW_tab", "cards": "y9bfmW_cards", "packageName": "y9bfmW_packageName" };
...
function MarketplaceSettingsSection({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: MarketplaceSettingsSection_default.section, "aria-busy": catalog.status === "loading" || installed.status === "loading", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: MarketplaceSettingsSection_default.tabs, role: "tablist", "aria-label": t("tabs"), children: ["discover", "installed"].map((id) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          ...
          children: t(id === "discover" ? "discoverTab" : "installedTab")
        },
        id
      );
    }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { className: MarketplaceSettingsSection_default.search, children: [
    ...
    props.filtered.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: MarketplaceSettingsSection_default.cards, children: props.filtered.map((entry) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { className: MarketplaceSettingsSection_default.card, "data-plugin-name": entry.name, children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: MarketplaceSettingsSection_default.cardTop, children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: MarketplaceSettingsSection_default.cardTitle, children: entry.title }),
            already ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: MarketplaceSettingsSection_default.tag, children: t("installedTag") }) : null
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: MarketplaceSettingsSection_default.packageName, children: [
            entry.name,
            entry.version.length > 0 ? `@${entry.version}` : ""
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: MarketplaceSettingsSection_default.sourceLabel, children: entry.sourceTitle }),
...
function InstalledPage(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    ...
    props.filtered.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: MarketplaceSettingsSection_default.list, children: props.filtered.map((entry) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { className: MarketplaceSettingsSection_default.card, "data-plugin-name": entry.packageName, children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: MarketplaceSettingsSection_default.cardTop, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: MarketplaceSettingsSection_default.headingRow, children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { children: t("cards") }) }),
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: MarketplaceSettingsSection_default.cards, children: props.renderCards() })
  ] });
}
