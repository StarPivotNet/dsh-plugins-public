...
- **已安装** — list, filter by kind or tag, add a local note and tags, uninstall, and toggle single Loader entries; hover for the full package name and spec, click the card for the full listing
