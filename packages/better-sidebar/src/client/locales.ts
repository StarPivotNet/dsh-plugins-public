...
export const zh = {
  ...
  settingsTitleBarDesc: '为桌面窗口右上角的原生标题栏预留空间：侧边栏按钮与侧边栏内容整体下移，避免被标题栏遮挡。桌面端默认开启',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  settingsTitleBarDesc: 'Reserve space for the native desktop title bar at the top-right so the sidebar buttons and content sit below it instead of underneath. On by default in the desktop app',
  ...
  browserGo: 'Go',
  browserActions: 'Address actions',
  browserBack: 'Back',
