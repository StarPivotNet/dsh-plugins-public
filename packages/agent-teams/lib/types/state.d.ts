...
export declare const CAPTAIN_POINTER_FILE = "captain-pointer.json";
 ...
 */
export declare function writeCaptainPointer(worktree: string, stateDir: string, pointer: CaptainPointer): Promise<void>;
/**
 ...
 */
export declare function resolveTeamWorkspace(ownCwd: string, stateDir: string): string;
/**
