...
var MarketplaceSettingsSection_default = { "tab": "y9bfmW_tab", "intro": "y9bfmW_intro", "button": "y9bfmW_button", "restart": "y9bfmW_restart", "hint": "y9bfmW_hint", "section": "y9bfmW_section", "panel": "y9bfmW_panel", "cards": "y9bfmW_cards", "list": "y9bfmW_list", "card": "y9bfmW_card", "packageName": "y9bfmW_packageName", "actions": "y9bfmW_actions", "status": "y9bfmW_status", "failure": "y9bfmW_failure", "cardTop": "y9bfmW_cardTop", "heading": "y9bfmW_heading", "tag": "y9bfmW_tag", "visuallyHidden": "y9bfmW_visuallyHidden", "cardTitle": "y9bfmW_cardTitle", "headingRow": "y9bfmW_headingRow", "empty": "y9bfmW_empty", "description": "y9bfmW_description", "field": "y9bfmW_field", "search": "y9bfmW_search", "tabs": "y9bfmW_tabs" };
...
function MarketplaceSettingsSection({
  ...
  const [draftUrl, setDraftUrl] = (0, import_react.useState)(catalogUrl);
...
function DiscoverPage(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: MarketplaceSettingsSection_default.field, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "marketplace-catalog-url", children: t("catalogUrl") }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          ...
          onChange: (event) => {
            props.onDraftUrl(event.currentTarget.value);
          }
        }
      ),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: MarketplaceSettingsSection_default.hint, children: t("catalogUrlHint") }),
...
function apply(ctx) {
  ...
  const injected = () => ({
    ...
    setCatalogUrl: async (value) => {
      await catalogScope.set("catalogUrl", value);
    }
  });
