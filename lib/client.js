...
var MarketplaceSettingsSection_default = { "actions": "y9bfmW_actions", "configList": "y9bfmW_configList", "source": "y9bfmW_source", "tag": "y9bfmW_tag", "cardTitle": "y9bfmW_cardTitle", "packageName": "y9bfmW_packageName", "empty": "y9bfmW_empty", "intro": "y9bfmW_intro", "tab": "y9bfmW_tab", "sources": "y9bfmW_sources", "heading": "y9bfmW_heading", "sourceLabel": "y9bfmW_sourceLabel", "description": "y9bfmW_description", "reloadToast": "y9bfmW_reloadToast", "hint": "y9bfmW_hint", "card": "y9bfmW_card", "failure": "y9bfmW_failure", "section": "y9bfmW_section", "restart": "y9bfmW_restart", "tabs": "y9bfmW_tabs", "field": "y9bfmW_field", "panel": "y9bfmW_panel", "list": "y9bfmW_list", "marketRow": "y9bfmW_marketRow", "status": "y9bfmW_status", "button": "y9bfmW_button", "headingRow": "y9bfmW_headingRow", "cards": "y9bfmW_cards", "visuallyHidden": "y9bfmW_visuallyHidden", "search": "y9bfmW_search" };
...
function reloadCardCopy(node, progress, names = []) {
...
var ReloadCommandCard_default = { "separator": "q9XtLq_separator", "root": "q9XtLq_root", "summary": "q9XtLq_summary", "body": "q9XtLq_body", "leading": "q9XtLq_leading", "title": "q9XtLq_title", "chevron": "q9XtLq_chevron", "row": "q9XtLq_row" };
...
function useReloadSnapshot(progress, names, source) {
  let cached = {
  ...
  return (0, import_react2.useSyncExternalStore)(
    ...
    () => {
      ...
      if (sameReloadProgress(cached.progress, next.progress) && cached.names.join("\0") === next.names.join("\0")) return cached;
      cached = next;
      return next;
    },
...
function ReloadCommandCard({ node, progress, names, progressSource }) {
...
function ReloadProgressToast(props) {
  ...
  if (props.notice !== void 0) {
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { className: MarketplaceSettingsSection_default.reloadToast, role: "status", children: [
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("strong", { children: props.notice.title }),
      /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("span", { children: props.notice.detail })
    ] });
  }
...
var zh = {
  ...
  reloadDone: "\u91CD\u8F7D\u5B8C\u6210",
  rebootDone: "\u5DF2\u91CD\u542F",
  rebootDoneDetail: "\u8FDB\u7A0B\u5DF2\u91CD\u65B0\u62C9\u8D77\uFF0C\u9875\u9762\u5DF2\u5237\u65B0"
};
var en = {
  nav: "Plugins",
  ...
  rebootDone: "Restarted",
  rebootDoneDetail: "The process is back and the page was refreshed"
};
...
function apply(ctx) {
  ...
  ctx.slots.inject("conversation.chat.commandview", () => ctx.slots.register({
    ...
    key: "reload",
    locale: NS
  }, (props) => (0, import_react4.createElement)(ReloadCommandCard, {
    node: props.node,
    progress: progressFromStatus(reloadStatus),
