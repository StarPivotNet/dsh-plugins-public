 ...
 *
 * Preference `session-rehome.rehomeMode` (General Settings) chooses ask vs
 * auto. Ask is the default and matches the historical rules: from No Repo, a
 * unique registered match executes immediately; leaving a real project, or
 * several matches, asks via ctx.userQuestions. Auto skips those prompts and
 * uses the model's canonical path when several workspaces match. Existing
 ...
 *
 * @module @starpivot/dsh-session-rehome
 */
...
export const RehomeModeSchema = z.object({
