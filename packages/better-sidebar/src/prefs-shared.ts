...
export interface SidebarPrefs {
   ...
   * desktop title bar (drawn at the window's top-right corner over the web
   ...
   * below it. On by default so desktop windows do not hide the collapse
   * buttons under the caption strip.
   */
