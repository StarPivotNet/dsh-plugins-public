 ...
 * differing: the official channel uses the package name (`@starpivot/dsh-better-sidebar`)
...
export default [
  ...
  clientBundle('@starpivot/dsh-better-sidebar', 'client.js'),
  // Plugin-registry channel: bundle id = manifest id (dsh.plugin.json `id`).
  clientBundle('starpivot/dsh-better-sidebar', 'client-registry.js'),
